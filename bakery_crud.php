...
if (isset($_POST['save_bakery'])) {
    ...
    $query = "INSERT INTO bakery(bk_name,bk_price,product_type_id,bk_number,bk_image,update_date,expire_date) VALUES(:bk_name,:bk_price,:product_type_id,:bk_number,:bk_image,:update_date,:expire_date)";
...
if (isset($_POST['bakery_edit'])) {
    ...
    $expire_date = $_POST['expire_date'];
    try {
        $query = "UPDATE bakery SET bk_name = :bk_name, bk_price = :bk_price, product_type_id = :product_type_id,bk_number = :bk_number, bk_image = :bk_image, update_date = :update_date, expire_date = :expire_date WHERE bk_id = :bk_id";
